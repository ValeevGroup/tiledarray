#
# Generic Toolchain for Clang + MVAPICH + MKL + TBB
#
# REQUIREMENTS:
# - in PATH:
...
set(CMAKE_CXX_FLAGS_INIT           "-stdlib=libstdc++ -fno-omit-frame-pointer -fno-optimize-sibling-calls -fstack-protector-strong" CACHE STRING "Initial C++ compile flags")
...
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O2 -g -Wall -ftemplate-backtrace-limit=0" CACHE STRING "Initial C++ release with debug info compile flags")
