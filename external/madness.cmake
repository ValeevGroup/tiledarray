...
elseif(TA_EXPERT)
  ...
  set(MADNESS_TAG "dedfc709e6a57bf2bfe7bf40501c98826df51585" CACHE STRING
  ...
  if (DEFINED LAPACK_LIBRARIES)
      set(MAD_LAPACK_OPTIONS "-DLAPACK_LIBRARIES=\"${LAPACK_LIBRARIES}\"" ${MAD_LAPACK_OPTIONS})
  ...
  message(STATUS "MAD_LAPACK_OPTIONS=${MAD_LAPACK_OPTIONS}")
