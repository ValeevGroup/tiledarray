...
elseif(TA_EXPERT)
  ...
  set(Madness_TAG "57ebfddaf2cc608c1e080519418e39cfb3811388" CACHE STRING 
  ...
  if(EXISTS ${MADNESS_SOURCE_DIR}/src/madness.h)
    ...
    message("$ git clone https://github.com/m-a-d-n-e-s-s/madness.git")
...
#  append_flags(MAD_LDFLAGS "${BLAS_LINKER_FLAGS}")
  if(LAPACK_LIBRARIES OR BLAS_LIBRARIES)
    if(UNIX AND BLA_STATIC)
      ...
      append_flags(MAD_LIBS "${LAPACK_LIBRARIES}")
  ...
  include(${MADNESS_BINARY_DIR}/madness-project.cmake)
