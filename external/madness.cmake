...
set(MADNESS_OLDEST_TAG "7404694125d4c3518fe52c0393dee352726030df" CACHE STRING
...
elseif(TA_EXPERT)
  ...
  if (DEFINED LAPACK_INCLUDE_DIRS)
      ...
      # stringize LAPACK_INCLUDE_DIRS
      string(REPLACE ";" " " STRINGIZED_LAPACK_INCLUDE_DIRS "${LAPACK_INCLUDE_DIRS}")
      set(MAD_LAPACK_OPTIONS "-DLAPACK_INCLUDE_DIRS=\"${STRINGIZED_LAPACK_INCLUDE_DIRS}\"" ${MAD_LAPACK_OPTIONS})
  ...
  if (DEFINED LAPACK_COMPILE_OPTIONS)
      ...
      # stringize LAPACK_COMPILE_OPTIONS
      string(REPLACE ";" " " STRINGIZED_LAPACK_COMPILE_OPTIONS "${LAPACK_COMPILE_OPTIONS}")
      set(MAD_LAPACK_OPTIONS "-DLAPACK_COMPILE_OPTIONS=\"${STRINGIZED_LAPACK_COMPILE_OPTIONS}\"" ${MAD_LAPACK_OPTIONS})
  ...
  if (DEFINED LAPACK_COMPILE_DEFINITIONS)
      ...
      # stringize LAPACK_COMPILE_DEFINITIONS
      string(REPLACE ";" " " STRINGIZED_LAPACK_COMPILE_DEFINITIONS "${LAPACK_COMPILE_DEFINITIONS}")
      set(MAD_LAPACK_OPTIONS "-DLAPACK_COMPILE_DEFINITIONS=\"${STRINGIZED_LAPACK_COMPILE_DEFINITIONS}\"" ${MAD_LAPACK_OPTIONS})
