...
BOOST_AUTO_TEST_CASE( lexicographical_order )
{
  { // check S5
    ...
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,2,3,4,5}},S5), true);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,1,300,300,500}},S5), true);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{300,300,300,300,5}},S5), false);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,1,0,0,5}},S5), false);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,2,3,4,0}},S5), false);
    BOOST_CHECK_EQUAL(is_orbit_minimum({1,2,3,4,5},S5), true); // try initializer_list as argument
    BOOST_CHECK_EQUAL(is_orbit_minimum({'a','b','c','d','e'},S5), true); // try initializer_list<char> as argument
  }
  ...
  { // check P5{(0,2,4)(1,3)}
    ...
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,2,3,4,5}},P), true);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,3,1,4,1}},P), true);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,2,1,1,1}},P), false);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,1,2,0,3}},P), false);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,2,2,3,1}},P), false);
  }
  ...
  { // check P4{(0,1),(2,3),(0,2)(1,3)}
    ...
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,2,3,4}},P), true);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,3,2,4}},P), true);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,2,2,4}},P), true);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{2,3,2,3}},P), true);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,2,3,2}},P), false);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{2,1,3,4}},P), false);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{1,3,1,2}},P), false);
    BOOST_CHECK_EQUAL(is_orbit_minimum(index_type{{2,3,1,4}},P), false);
  }
