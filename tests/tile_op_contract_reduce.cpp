...
BOOST_AUTO_TEST_CASE( double_matrix_multiply )
{
  // Set dimension constants
  const std::size_t
      left_outer_start = 2, left_outer_finish = 20,
  ...
  // Construct tensors
  tensor_type left1 = make_tensor(left_outer_start, inner_start, left_outer_finish, inner_finish);
  tensor_type left2 = make_tensor(left_outer_start, inner_start, left_outer_finish, inner_finish);
  tensor_type left1T = make_tensor(inner_start, left_outer_start, inner_finish, left_outer_finish);
  tensor_type left2T = make_tensor(inner_start, left_outer_start, inner_finish, left_outer_finish);
  tensor_type right1 = make_tensor(inner_start, right_outer_start, inner_finish, right_outer_finish);
  tensor_type right2 = make_tensor(inner_start, right_outer_start, inner_finish, right_outer_finish);
  tensor_type right1T = make_tensor(right_outer_start, inner_start, right_outer_finish, inner_finish);
  tensor_type right2T = make_tensor(right_outer_start, inner_start, right_outer_finish, inner_finish);
  ...
  // Construct matrix maps for argument tensors
  Eigen::Map<const matrix_type, Eigen::AutoAlign>
    A1(left1.data(), m, k), B1(right1.data(), k, n),
    A2(left2.data(), m, k), B2(right2.data(), k, n),
    A1T(left1T.data(), k, m), B1T(right1T.data(), n, k),
    A2T(left2T.data(), k, m), B2T(right2T.data(), n, k);
  ...
  // Test NoTrans, NoTrans
  {
    ...
    // Do contraction operation
    BOOST_REQUIRE_NO_THROW(op(result, left1, right1, left2, right2));
  }

  // Compute reference values and compare to the result
  matrix_type  C = 3 * (A1 * B1 + A2 * B2);
  Eigen::Map<const matrix_type, Eigen::AutoAlign> result_map(result.data(), m, n);
  BOOST_CHECK_EQUAL(result_map, C);
  ...
  // Test Trans, NoTrans
  {
    ...
    // Do contraction operation
    BOOST_REQUIRE_NO_THROW(op(result, left1T, right1, left2T, right2));
  }
  ...
  // Compute reference values and compare to the result
  C.noalias() += 3 * (A1T.transpose() * B1 + A2T.transpose() * B2);
  BOOST_CHECK_EQUAL(result_map, C);
  ...
  // Test NoTrans, Trans
  {
    ...
    // Do contraction operation
    BOOST_REQUIRE_NO_THROW(op(result, left1, right1T, left2, right2T));
  }
  ...
  // Compute reference values and compare to the result
  C.noalias() += 3 * (A1 * B1T.transpose() + A2 * B2T.transpose());
  BOOST_CHECK_EQUAL(result_map, C);
  ...
  // Test Trans, Trans
  {
    ...
    // Do contraction operation
    BOOST_REQUIRE_NO_THROW(op(result, left1T, right1T, left2T, right2T));
  }
  ...
  // Compute reference values and compare to the result
  C.noalias() += 3 * (A1T.transpose() * B1T.transpose() + A2T.transpose() * B2T.transpose());
  BOOST_CHECK_EQUAL(result_map, C);
}
...
BOOST_AUTO_TEST_CASE( double_tensor_contract1 )
{
  // Set dimension constants
  const std::size_t
      left_outer_start = 2, left_outer_finish = 20,
  ...
  // Construct tensors
  tensor_type left1 = make_tensor(left_outer_start, inner1_start, inner2_start, left_outer_finish, inner1_finish, inner2_finish);
  tensor_type left2 = make_tensor(left_outer_start, inner1_start, inner2_start, left_outer_finish, inner1_finish, inner2_finish);
  tensor_type right1 = make_tensor(inner1_start, inner2_start, right_outer_start, inner1_finish, inner2_finish, right_outer_finish);
  tensor_type right2 = make_tensor(inner1_start, inner2_start, right_outer_start, inner1_finish, inner2_finish, right_outer_finish);
  tensor_type left1T = make_tensor(inner1_start, inner2_start, left_outer_start, inner1_finish, inner2_finish, left_outer_finish);
  tensor_type left2T = make_tensor(inner1_start, inner2_start, left_outer_start, inner1_finish, inner2_finish, left_outer_finish);
  tensor_type right1T = make_tensor(right_outer_start, inner1_start, inner2_start, right_outer_finish, inner1_finish, inner2_finish);
  tensor_type right2T = make_tensor(right_outer_start, inner1_start, inner2_start, right_outer_finish, inner1_finish, inner2_finish);
...
BOOST_AUTO_TEST_CASE( double_tensor_contract2 )
{
  // Set dimension constants
  const std::size_t
      left_outer1_start = 2, left_outer1_finish = 20,
  ...
  // Construct tensors
  tensor_type left1 = make_tensor(left_outer1_start, left_outer2_start, inner_start, left_outer1_finish, left_outer2_finish, inner_finish);
  tensor_type left2 = make_tensor(left_outer1_start, left_outer2_start, inner_start, left_outer1_finish, left_outer2_finish, inner_finish);
  tensor_type right1 = make_tensor(inner_start, right_outer1_start, right_outer2_start, inner_finish, right_outer1_finish, right_outer2_finish);
  tensor_type right2 = make_tensor(inner_start, right_outer1_start, right_outer2_start, inner_finish, right_outer1_finish, right_outer2_finish);
  tensor_type left1T = make_tensor(inner_start, left_outer1_start, left_outer2_start, inner_finish, left_outer1_finish, left_outer2_finish);
  tensor_type left2T = make_tensor(inner_start, left_outer1_start, left_outer2_start, inner_finish, left_outer1_finish, left_outer2_finish);
  tensor_type right1T = make_tensor(right_outer1_start, right_outer2_start, inner_start, right_outer1_finish, right_outer2_finish, inner_finish);
  tensor_type right2T = make_tensor(right_outer1_start, right_outer2_start, inner_start, right_outer1_finish, right_outer2_finish, inner_finish);
