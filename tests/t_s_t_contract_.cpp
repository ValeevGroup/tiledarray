...
BOOST_AUTO_TEST_CASE(ijk_ijk) {
  ...
  Tensor<double> rhs(
      Range{4, 2, 6},
      {98, 99, 25, 83, 14, 50, 89, 78, 71, 8,  69, 3,  66, 98, 25, 90,
       32, 17, 35, 39, 27, 4,  32, 63, 38, 14, 88, 73, 93, 18, 31, 86,
       41, 98, 21, 75, 68, 97, 78, 51, 78, 68, 11, 78, 97, 59, 86, 79});
  Tensor<double> corr(
      Range{4, 2, 6},
      {294.0, 297.0, 75.0,  249.0, 42.0,  150.0, 267.0, 234.0, 213.0, 24.0,
       207.0, 9.0,   198.0, 294.0, 75.0,  270.0, 96.0,  51.0,  105.0, 117.0,
...
BOOST_AUTO_TEST_CASE(ikj_ijk) {
  ...
  Tensor<double> corr(
      Range{4, 6, 2},
      {294.0, 267.0, 297.0, 234.0, 75.0,  213.0, 249.0, 24.0,  42.0,  207.0,
       150.0, 9.0,   198.0, 105.0, 294.0, 117.0, 75.0,  81.0,  270.0, 12.0,
...
BOOST_AUTO_TEST_CASE(jik_ijk) {
  ...
  Tensor<double> corr(
      Range{2, 4, 6},
      {294.0, 297.0, 75.0,  249.0, 42.0,  150.0, 198.0, 294.0, 75.0,  270.0,
       96.0,  51.0,  114.0, 42.0,  264.0, 219.0, 279.0, 54.0,  204.0, 291.0,
...
BOOST_AUTO_TEST_CASE(jki_ijk) {
  ...
  Tensor<double> corr(
      Range{2, 6, 4},
      {294.0, 198.0, 114.0, 204.0, 297.0, 294.0, 42.0,  291.0, 75.0,  75.0,
       264.0, 234.0, 249.0, 270.0, 219.0, 153.0, 42.0,  96.0,  279.0, 234.0,
...
BOOST_AUTO_TEST_CASE(kij_ijk) {
  ...
  Tensor<double> corr(
      Range{6, 4, 2},
      {294.0, 267.0, 198.0, 105.0, 114.0, 93.0,  204.0, 33.0,  297.0, 234.0,
       294.0, 117.0, 42.0,  258.0, 291.0, 234.0, 75.0,  213.0, 75.0,  81.0,
...
BOOST_AUTO_TEST_CASE(kji_ijk) {
  ...
  Tensor<double> corr(
      Range{6, 2, 4},
      {294.0, 198.0, 114.0, 204.0, 267.0, 105.0, 93.0,  33.0,  297.0, 294.0,
       42.0,  291.0, 234.0, 117.0, 258.0, 234.0, 75.0,  75.0,  264.0, 234.0,
