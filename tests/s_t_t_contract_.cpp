...
BOOST_AUTO_TEST_CASE(i_i) {
  ...
  double corr = 10416;
  BipartiteVariableList oidx, lidx("i"), ridx("i");
...
BOOST_AUTO_TEST_CASE(ij_ij) {
  ...
  double corr = 14889;
  BipartiteVariableList oidx, lidx("i,j"), ridx("i,j");
  auto rv = kernels::s_t_t_contract_(oidx, lidx, ridx, lhs, rhs);
  BOOST_CHECK_EQUAL(rv, corr);
}
...
BOOST_AUTO_TEST_CASE(ij_ji) {
  ...
  double corr = 23555;
  BipartiteVariableList oidx, lidx("i,j"), ridx("j,i");
  auto rv = kernels::s_t_t_contract_(oidx, lidx, ridx, lhs, rhs);
  BOOST_CHECK_EQUAL(rv, corr);
}
...
BOOST_AUTO_TEST_CASE(ijk_ijk) {
  ...
  double corr = 117914;
  BipartiteVariableList oidx, lidx("i,j,k"), ridx("i,j,k");
  auto rv = kernels::s_t_t_contract_(oidx, lidx, ridx, lhs, rhs);
  BOOST_CHECK_EQUAL(rv, corr);
}
...
BOOST_AUTO_TEST_CASE(ijk_ikj) {
  ...
  double corr = 128743;
  BipartiteVariableList oidx, lidx("i,j,k"), ridx("i,k,j");
  auto rv = kernels::s_t_t_contract_(oidx, lidx, ridx, lhs, rhs);
  BOOST_CHECK_EQUAL(rv, corr);
}
...
BOOST_AUTO_TEST_CASE(ijk_jik) {
  ...
  double corr = 128234;
  BipartiteVariableList oidx, lidx("i,j,k"), ridx("j,i,k");
  auto rv = kernels::s_t_t_contract_(oidx, lidx, ridx, lhs, rhs);
  BOOST_CHECK_EQUAL(rv, corr);
}
...
BOOST_AUTO_TEST_CASE(ijk_jki) {
  ...
  double corr = 127241;
  BipartiteVariableList oidx, lidx("i,j,k"), ridx("j,k,i");
  auto rv = kernels::s_t_t_contract_(oidx, lidx, ridx, lhs, rhs);
  BOOST_CHECK_EQUAL(rv, corr);
}
...
BOOST_AUTO_TEST_CASE(ijk_kij) {
  ...
  double corr = 151236;
  BipartiteVariableList oidx, lidx("i,j,k"), ridx("k,i,j");
  auto rv = kernels::s_t_t_contract_(oidx, lidx, ridx, lhs, rhs);
  BOOST_CHECK_EQUAL(rv, corr);
}
...
BOOST_AUTO_TEST_CASE(ijk_kji) {
  ...
  double corr = 109489;
  BipartiteVariableList oidx, lidx("i,j,k"), ridx("k,j,i");
  auto rv = kernels::s_t_t_contract_(oidx, lidx, ridx, lhs, rhs);
  BOOST_CHECK_EQUAL(rv, corr);
}
