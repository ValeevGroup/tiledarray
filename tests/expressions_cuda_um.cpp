...
//      for(i[1] = tile.range().lobound(1); i[1] < tile.range().upbound(1);
//      ++i[1]) {
//          BOOST_CHECK_EQUAL(tile(i[0], i[1]), result(i[0], i[1]) * 5);
//      }
//    }
//  }
//
...
//      for(i[1] = tile.range().lobound(1); i[1] < tile.range().upbound(1);
//      ++i[1]) {
//          BOOST_CHECK_EQUAL(tile(i[0], i[1]), result(i[0], i[1]) * 10);
//      }
//    }
//  }
//
...
//      for(i[1] = tile.range().lobound(1); i[1] < tile.range().upbound(1);
//      ++i[1]) {
//          BOOST_CHECK_EQUAL(tile(i[0], i[1]), result(i[0], i[1]) * 15);
//      }
//    }
//  }
//
...
//      for(i[1] = tile.range().lobound(1); i[1] < tile.range().upbound(1);
//      ++i[1]) {
//          BOOST_CHECK_EQUAL(tile(i[0], i[1]), result(i[0], i[1]) * 30);
//      }
//    }
//  }
//}
...
//          const std::size_t c = i[1] * a.trange().elements_range().stride(1)
//                                + i[2] *
//                                a.trange().elements_range().stride(2);
//
//          left(r, c) = tile(i[0], i[1], i[2]);
//        }
//      }
