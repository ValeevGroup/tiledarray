...
cmake .. -DCMAKE_INSTALL_PREFIX=../_install -DCMAKE_CXX_COMPILER=$CXX \
  ...
  -DMADNESS_CMAKE_EXTRA_ARGS="-Wno-dev;-DELEMENTAL_CMAKE_BUILD_TYPE=Debug;-DELEMENTAL_CXXFLAGS='-fext-numeric-literals';-DELEMENTAL_CMAKE_EXTRA_ARGS='-DCMAKE_Fortran_COMPILER=gfortran-5'"
