...
int main(int argc, char** argv) {
  ...
  try {
    ...
    blockingA.reserve(2);
    blockingA.push_back(TiledArray::TiledRange1(blocking[0].begin(), blocking[0].end()));
    blockingA.push_back(TiledArray::TiledRange1(blocking[1].begin(), blocking[1].end()));
    blockingB.reserve(2);
    blockingB.push_back(TiledArray::TiledRange1(blocking[1].begin(), blocking[1].end()));
    blockingB.push_back(TiledArray::TiledRange1(blocking[2].begin(), blocking[2].end()));

    TiledArray::TiledRange
      trangeA(blockingA.begin(), blockingA.end()),
