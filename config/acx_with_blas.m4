    ...
    if test $acx_have_blas = no; then
      AC_CHECK_FUNC([jag_dgemm],
        [
          ...
          AC_DEFINE([sgemv], [jag_sgemv], [Alias BLAS sgemm function name])
          AC_DEFINE([dgemv], [jag_dgemv], [Alias BLAS dgemm function name])
          AC_DEFINE([cgemv], [jag_cgemv], [Alias BLAS cgemm function name])
          AC_DEFINE([zgemv], [jag_zgemv], [Alias BLAS zgemm function name])
          AC_DEFINE([sger], [jag_sger], [Alias BLAS sgemm function name])
          AC_DEFINE([dger], [jag_dger], [Alias BLAS dgemm function name])
          AC_DEFINE([cger], [jag_cger], [Alias BLAS cgemm function name])
          AC_DEFINE([zger], [jag_zger], [Alias BLAS zgemm function name])
    ...
    if test $acx_have_blas = no; then
      AC_CHECK_FUNC([dgemm_],
        [
          ...
          AC_DEFINE([sgemv], [sgemv_], [Alias BLAS sgemv function name])
          AC_DEFINE([dgemv], [dgemv_], [Alias BLAS dgemv function name])
          AC_DEFINE([cgemv], [cgemv_], [Alias BLAS cgemv function name])
          AC_DEFINE([zgemv], [zgemv_], [Alias BLAS zgemv function name])
          AC_DEFINE([sger], [sger_], [Alias BLAS sger function name])
          AC_DEFINE([dger], [dger_], [Alias BLAS dger function name])
          AC_DEFINE([cger], [cger_], [Alias BLAS cger function name])
          AC_DEFINE([zger], [zger_], [Alias BLAS zger function name])
    ...
    if test $acx_have_blas = no; then
      AC_CHECK_FUNC([dgemm__],
        [
          ...
          AC_DEFINE([sgemv], [sgemv__], [Alias BLAS sgemv function name])
          AC_DEFINE([dgemv], [dgemv__], [Alias BLAS dgemv function name])
          AC_DEFINE([cgemv], [cgemv__], [Alias BLAS cgemv function name])
          AC_DEFINE([zgemv], [zgemv__], [Alias BLAS zgemv function name])
          AC_DEFINE([sger], [sger__], [Alias BLAS sger function name])
          AC_DEFINE([dger], [dger__], [Alias BLAS dger function name])
          AC_DEFINE([cger], [cger__], [Alias BLAS cger function name])
          AC_DEFINE([zger], [zger__], [Alias BLAS zger function name])
    ...
    if test $acx_have_blas = no; then
      AC_CHECK_FUNC([DGEMM],
        [
          ...
          AC_DEFINE([sgemv], [SGEMV], [Alias BLAS sgemv function name])
          AC_DEFINE([dgemv], [DGEMV], [Alias BLAS dgemv function name])
          AC_DEFINE([cgemv], [CGEMV], [Alias BLAS cgemv function name])
          AC_DEFINE([zgemv], [ZGEMV], [Alias BLAS zgemv function name])
          AC_DEFINE([sger], [SGER], [Alias BLAS sger function name])
          AC_DEFINE([dger], [DGER], [Alias BLAS dger function name])
          AC_DEFINE([cger], [CGER], [Alias BLAS cger function name])
          AC_DEFINE([zger], [ZGER], [Alias BLAS zger function name])
