...
namespace TiledArray {
  ...
  namespace expressions {
    namespace array {
      ...
      template<typename T>
      class AnnotatedArrayImpl : public madness::WorldObject< AnnotatedArrayImpl<T> >, Annotation {
      public:
      ...
      public:
        ...
        AnnotatedArrayImpl(array_ptr a, const VariableList& v, detail::DimensionOrderType o) :
            ...
            Annotation(a->size_pair().first, a->size_pair().second, a->weight_pair().first,
            a->weight_pair().second, a->volume(), v, o),
            array_(a)
        {
