...
namespace TiledArray {
  ...
  /// to g1.permutation() * g2.permutation() and the resulting symmetry flag is
  /// equal to g1.symmetry() * g2.symmetry().
  GroupElement operator*(GroupElement g1, GroupElement g2) {
