...
namespace TiledArray {
  namespace detail {
    ...
    template <typename T>
    inline void mxm(const long m, const long n, const long k, const T* a, const T* b, T* c) {
    ...
    inline void mxm(const long m, const long n, const long k, const std::complex<float>* a, const std::complex<float>* b, std::complex<float>* c) {
