...
class CP_THC_ALS : public CP<Tile, Policy> {
 public:
  ...
  // arbitrary order.
  CP_THC_ALS(const DistArray<Tile, Policy>& tref1,
             const DistArray<Tile, Policy>& tref2,
             const DistArray<Tile, Policy>& tref3)
      : CP<Tile, Policy>(2 * rank(tref3)),
        ref_orb_a(tref1),
        ref_orb_b(tref2),
        ref_core(tref3),
    ...
    pr("r,rp") = (ref_orb_a("a,r") * ref_orb_a("a,rp")) *
                 (ref_orb_b("i,r") * ref_orb_b("i,rp"));
  ...
  CP_THC_ALS(const DistArray<Tile, Policy>& tref1,
             const DistArray<Tile, Policy>& tref2,
             const DistArray<Tile, Policy>& core,
             const DistArray<Tile, Policy>& tref3,
             const DistArray<Tile, Policy>& tref4)
      : CP<Tile, Policy>(2 * rank(tref3)),
        ref_orb_a(tref1),
        ref_orb_b(tref2),
        ref_core(core),
    ...
    pr("p,r") = ((ref_orb_a("a,p") * ref_orb_a("a,r")) *
                 (ref_orb_b("i,p") * ref_orb_b("i,r")));
    pq("p,q") = pr("p,r") * ref_core("r,q");
    pr("p,q") = ref_core("p,r") * ((ref_orb_c("b,r") * ref_orb_c("b,q")) *
                                   (ref_orb_d("j,r") * ref_orb_d("j,q")));
 ...
 protected:
  const DistArray<Tile, Policy>&ref_orb_a, ref_orb_b, ref_core, ref_orb_c,
      ref_orb_d;
  madness::World& world;
  ...
  void update_factor(size_t mode, size_t rank) {
    ...
    // First we need to take other side of the problem and contract it with the
    // core if core is greater than 2 I need to contract all the centers but
    ...
    // Starting the second factor
    {
      ...
      Bn("q,b") =
          einsum(pq("p,q"), env("p,q"), "p,q")("p,q") * ref_orb_b("b,p");
      ...
      THC_times_CPD[mode]("p,q") *=
          ref_orb_b("b,p") * cp_factors[pos_plus_one]("q,b");
    }
  }
  void update_factors_left() {
    ...
    DistArray<Tile, Policy> env, pq, W_env, W;
    {
      ...
      // use SVD
      W_env("p,q") =
          this->partial_grammian[2]("p,q") * this->partial_grammian[3]("p,q");
  ...
  void update_factors_right() {
    ...
    DistArray<Tile, Policy> env, pq, W_env, W;
    {
      ...
      // use SVD
      W_env("p,q") =
          this->partial_grammian[0]("p,q") * this->partial_grammian[1]("p,q");
