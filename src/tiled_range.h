...
namespace TiledArray {
  ...
  class TiledRange : boost::equality_comparable1< TiledRange<I,DIM,CS> > {
	public:
      ...
      typedef TiledRange1<I> range1_type;
    ...
    private:
      ...
      void init_() {
        ...
        boost::shared_ptr<tile_range_type> tile_block;
        ...
        for(typename range_type::const_iterator it = block_.begin(); it != block_.end(); ++it) {
          ...
          tile_blocks_[ *it ] = tile_range_type(start_tile, finish_tile);
          tile_block.reset();
        }
      }
      ...
      element_range_type element_block_;
